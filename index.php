...
$db=$GLOBALS['db'];
$food_menuItemsNew = $db->getFoodMenu();
$weekly_foodItemsNew = $db->getWeeklyFood();
...
<body>
    ...
    <section class="services">
        <div class="container">
            <div class="row">
                    <?php
                    foreach ($food_menuItemsNew as $f_Item){

                    ?>
                  <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="service-item">
                        <a href="menu.php">
                        <img src=<?php echo $f_Item['image']; ?> alt=<?php echo $f_Item['sys_name']; ?> >
                        <h4><?php echo $f_Item['display_name']; ?></h4>
                        </a>
                    </div>
                </div>
                <?php
    ...
    <section class="featured-food">
        <div class="container">
            ...
            <div class="row">
                <?php
                foreach ($weekly_foodItemsNew as $wf_Item){

                ?>

                <div class="col-md-4">
                    <div class="food-item">
                        <h2><?php echo $wf_Item['display_name']; ?></h2>
                        <img src="<?php echo $wf_Item['image']; ?>" alt="">
                        <div class="price"><?php echo $wf_Item['price']; ?> €</div>
                        <div class="text-content">
                            <h4><?php echo $wf_Item['food_name']; ?></h4>
                            <p> <?php echo $wf_Item['description']; ?></p>
                        </div>
                    </div>
                </div>
                    <?php
    ...
    <section class="our-blog">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="blog-post">
                        <img src="<?php echo $b_Item['image']; ?>" alt="">
